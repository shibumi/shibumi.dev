...
![gnu-netcat in action]({{ sitebase.url }}/img/ez_pz_1.png)
...
![radare2 in action]({{ sitebase.url }}/img/ez_pz_2.png)
...
![radare2 in action2]({{ sitebase.url }}/img/ez_pz_3.png)
...
![radare2 in action3]({{ sitebase.url }}/img/ez_pz_4.png)
